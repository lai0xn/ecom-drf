...
from .views import ColorViewSet, CouponViewSet, MediaViewSet, ProductViewSet, ReviewViewSet, SizeViewSet, add_to_wishlist, check_coupon, get_wishlist, remove_from_wishlist
